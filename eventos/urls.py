...
urlpatterns = [
    ...
    path('pagamento/ipn/', views.mercado_pago_ipn, name='mercado_pago_ipn'),
    path('perfil/mp/conectar/', views.mercado_pago_connect_auth, name='mp_connect_auth'),
    path('perfil/mp/callback/', views.mercado_pago_connect_callback, name='mp_connect_callback'),
]